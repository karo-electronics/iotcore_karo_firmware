...
class PlatformBuilder(UefiBuilder):
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("ACTIVE_PLATFORM", "KARO/TX8M_MINI_EVK_1GB/TX8M_MINI_EVK_1GB.dsc", "Platform Hardcoded")
        self.env.SetValue("PRODUCT_NAME", "TX8M_MINI_EVK_1GB", "Platform Hardcoded")
    ...
    def SetPlatformEnvAfterTarget(self):
        ...
        self.env.SetValue("BUILD_OUTPUT_BASE", value, "Computed in TX8M_MINI_EVK_1GB Build")

        # Output FD file
        key = "OUTPUT_FD"
        value = os.path.join(self.env.GetValue("BUILD_OUTPUT_BASE"), "FV", "ClientBios.fd")
        self.env.SetValue(key, value, "Computed in TX8M_MINI_EVK_1GBBuild")

        # Output ROM directory
        key = "OUTPUT_ROM_DIR"
        value = os.path.join(self.env.GetValue("BUILD_OUTPUT_BASE"), "ROM")
        self.env.SetValue(key, value, "Computed in TX8M_MINI_EVK_1GB Build")
