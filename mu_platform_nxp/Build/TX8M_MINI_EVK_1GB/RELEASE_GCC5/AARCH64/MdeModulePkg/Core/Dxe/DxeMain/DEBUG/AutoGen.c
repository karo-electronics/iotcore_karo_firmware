...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiCpu2ProtocolGuid = { 0x55198405, 0x26C0, 0x4765, {0x8B, 0x7D, 0xBE, 0x1D, 0xF5, 0xF9, 0x97, 0x12 }};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gHeapGuardDebugProtocolGuid = { 0xe8150630, 0x6366, 0x4294, { 0xa3, 0x47, 0x89, 0x2c, 0x3a, 0x7d, 0xe4, 0xaf } };
...
#define _PCD_TOKEN_PcdExtFpdtBootRecordPadSize  85U
...
#define _PCD_TOKEN_PcdDebuggerExceptionSupport  86U
...
#define _PCD_TOKEN_PcdCpuVectorBaseAddress  87U
