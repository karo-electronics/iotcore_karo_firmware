...
#define _PCD_TOKEN_PcdArmReenterPeiForCapsuleWarmReboot  92U
#define _PCD_SIZE_PcdArmReenterPeiForCapsuleWarmReboot 1
#define _PCD_GET_MODE_SIZE_PcdArmReenterPeiForCapsuleWarmReboot  _PCD_SIZE_PcdArmReenterPeiForCapsuleWarmReboot 
#define _PCD_VALUE_PcdArmReenterPeiForCapsuleWarmReboot  ((BOOLEAN)0U)
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdArmReenterPeiForCapsuleWarmReboot = _PCD_VALUE_PcdArmReenterPeiForCapsuleWarmReboot;
