...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gCapsuleArmedResetGuid = {0xc6b4eea7, 0xfce2, 0x4625, {0x9c, 0x4f, 0xc4, 0xb0, 0x82, 0x37, 0xae, 0x23}};
  ...
  )
{
  ...
  Status = RuntimeResetSystemLibConstruct (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
  ...
  )
{
  ...
  Status = RuntimeResetSystemLibDeconstruct (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
