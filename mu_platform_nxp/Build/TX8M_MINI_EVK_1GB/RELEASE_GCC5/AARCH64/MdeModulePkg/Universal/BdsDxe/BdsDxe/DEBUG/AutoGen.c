...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiEventPreReadyToBootGuid = { 0x7b94c75c, 0x36a4, 0x4aa4, {0xa1, 0xdf, 0x14, 0xbc, 0x9a, 0x04, 0x9a, 0xe4}};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiEventPostReadyToBootGuid = { 0xa5b489b4, 0x18fd, 0x4425, { 0x91, 0xa4, 0x61, 0x3a, 0xdd, 0xd2, 0x74, 0x5 }};
...
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdPlatformRecoverySupported = _PCD_VALUE_PcdPlatformRecoverySupported;
...
#define _PCD_TOKEN_PcdReportStatusCodePropertyMask  84U
...
#define _PCD_VALUE_PcdReportStatusCodePropertyMask  0x47U
...
#define _PCD_TOKEN_PcdResetOnMemoryTypeInformationChange  103U
...
#define _PCD_TOKEN_PcdProgressCodeOsLoaderLoad  104U
...
#define _PCD_TOKEN_PcdProgressCodeOsLoaderStart  105U
...
#define _PCD_TOKEN_PcdDriverHealthConfigureForm  108U
...
#define _PCD_TOKEN_PcdBootManagerInBootOrder  110U
#define _PCD_SIZE_PcdBootManagerInBootOrder 1
#define _PCD_GET_MODE_SIZE_PcdBootManagerInBootOrder  _PCD_SIZE_PcdBootManagerInBootOrder 
#define _PCD_VALUE_PcdBootManagerInBootOrder  1U
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdBootManagerInBootOrder = _PCD_VALUE_PcdBootManagerInBootOrder;
extern const  BOOLEAN  _gPcd_FixedAtBuild_PcdBootManagerInBootOrder;
#define _PCD_GET_MODE_BOOL_PcdBootManagerInBootOrder  _gPcd_FixedAtBuild_PcdBootManagerInBootOrder
//#define _PCD_SET_MODE_BOOL_PcdBootManagerInBootOrder  ASSERT(FALSE)  // It is not allowed to set value for a FIXED_AT_BUILD PCD
...
#define _PCD_PATCHABLE_VALUE_PcdVideoHorizontalResolution  ((UINT32)1280U)
...
#define _PCD_PATCHABLE_VALUE_PcdVideoVerticalResolution  ((UINT32)800U)
  ...
  )
{
  ...
  Status = DeviceBootManagerConstructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);

  Status = PlatformBootManagerEntry (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
