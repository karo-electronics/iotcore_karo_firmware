...
#define _PCD_TOKEN_PcdUefiVariableDefaultLang  151U
...
#define _PCD_TOKEN_PcdFirmwareVendor  192U
...
#define _PCD_TOKEN_PcdPlatformRecoverySupported  194U
#define _PCD_SIZE_PcdPlatformRecoverySupported 1
#define _PCD_GET_MODE_SIZE_PcdPlatformRecoverySupported  _PCD_SIZE_PcdPlatformRecoverySupported 
#define _PCD_VALUE_PcdPlatformRecoverySupported  1U
extern const  BOOLEAN  _gPcd_FixedAtBuild_PcdPlatformRecoverySupported;
#define _PCD_GET_MODE_BOOL_PcdPlatformRecoverySupported  _gPcd_FixedAtBuild_PcdPlatformRecoverySupported
//#define _PCD_SET_MODE_BOOL_PcdPlatformRecoverySupported  ASSERT(FALSE)  // It is not allowed to set value for a FIXED_AT_BUILD PCD
