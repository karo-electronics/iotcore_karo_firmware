...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xA9945BAB, 0x78C9, 0x43C9, {0x91, 0x75, 0xF5, 0x76, 0xCA, 0x18, 0x98, 0x70}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SdhcDxe";
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiSdhcProtocolGuid = { 0x46055b0f, 0x992a, 0x4ad7, { 0x8f, 0x81, 0x14, 0x81, 0x86, 0xff, 0xdf, 0x72 } };
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdSdhc1Base = _PCD_VALUE_PcdSdhc1Base;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdSdhc1CardDetectSignal = _PCD_VALUE_PcdSdhc1CardDetectSignal;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdSdhc1Enable = _PCD_VALUE_PcdSdhc1Enable;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdSdhc1WriteProtectSignal = _PCD_VALUE_PcdSdhc1WriteProtectSignal;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdSdhc2Base = _PCD_VALUE_PcdSdhc2Base;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdSdhc2CardDetectSignal = _PCD_VALUE_PcdSdhc2CardDetectSignal;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdSdhc2Enable = _PCD_VALUE_PcdSdhc2Enable;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdSdhc2WriteProtectSignal = _PCD_VALUE_PcdSdhc2WriteProtectSignal;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdSdhc3Base = _PCD_VALUE_PcdSdhc3Base;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdSdhc3CardDetectSignal = _PCD_VALUE_PcdSdhc3CardDetectSignal;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdSdhc3Enable = _PCD_VALUE_PcdSdhc3Enable;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdSdhc3WriteProtectSignal = _PCD_VALUE_PcdSdhc3WriteProtectSignal;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdSdhc4Base = _PCD_VALUE_PcdSdhc4Base;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdSdhc4CardDetectSignal = _PCD_VALUE_PcdSdhc4CardDetectSignal;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdSdhc4Enable = _PCD_VALUE_PcdSdhc4Enable;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdSdhc4WriteProtectSignal = _PCD_VALUE_PcdSdhc4WriteProtectSignal;
...
{
  return SdhcInitialize (ImageHandle, SystemTable);
}
