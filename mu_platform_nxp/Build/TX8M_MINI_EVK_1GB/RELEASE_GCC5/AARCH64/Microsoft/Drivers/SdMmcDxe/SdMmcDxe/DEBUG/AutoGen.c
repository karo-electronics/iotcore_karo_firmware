...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x16738C4A, 0x8044, 0x4DD8, {0xB6, 0x8E, 0x58, 0xA5, 0x3C, 0xEF, 0xF5, 0xD9}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SdMmcDxe";
...
{
  return SdMmcDxeInitialize (ImageHandle, SystemTable);
}
