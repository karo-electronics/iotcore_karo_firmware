...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x6E261F6C, 0x4CF8, 0xDF84, {0x92, 0x26, 0x17, 0xA3, 0x60, 0xB0, 0x3D, 0x84}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "iMX8Dxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gArmBootMonFsFileInfoGuid = { 0x41e26b9c, 0xada6, 0x45b3, { 0x80, 0x8e, 0x23, 0x57, 0xa3, 0x5b, 0x60, 0xd6 } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEdkiiNonDiscoverableAmbaDeviceGuid = { 0x94440339, 0xCC93, 0x4506, {0xB4, 0xC6, 0xEE, 0x8D, 0x0F, 0x4C, 0xA1, 0x91 } };
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdHypFvBaseAddress = _PCD_VALUE_PcdHypFvBaseAddress;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdHypFvSize = _PCD_VALUE_PcdHypFvSize;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdUsb1XhciBaseAddress = _PCD_VALUE_PcdUsb1XhciBaseAddress;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdUsb2XhciBaseAddress = _PCD_VALUE_PcdUsb2XhciBaseAddress;
...
#define _PCD_TOKEN_PcdUefiFileHandleLibPrintBufferSize  159U
...
#define _PCD_TOKEN_PcdShellLibAutoInitialize  160U
...
#define _PCD_TOKEN_PcdShellPrintBufferSize  161U
...
{
  return iMX8EntryPoint (ImageHandle, SystemTable);
}
