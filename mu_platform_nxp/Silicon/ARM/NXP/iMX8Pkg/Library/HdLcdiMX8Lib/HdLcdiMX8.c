...
/* ToDo: KaRo: avoid hardcoding of display parameters */
  Info->HorizontalResolution = WXGA_H_RES_PIXELS;
  Info->VerticalResolution = WXGA_V_RES_PIXELS;
  Info->PixelsPerScanLine = WXGA_H_RES_PIXELS;
